...
export interface SettingDocumentDataNavitemItem {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.navitem[].link
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.navitem[].label
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
interface SettingDocumentData {
  ...
  /**
   * Linked Link field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.linked_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  linked_link: prismic.LinkField;
...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Descriptions field in *Biography → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.descriptions
